...
set_global_assignment -name SYSTEMVERILOG_FILE "${PCIE_SHIMS_DIR}/pcie_bus_width/ofs_fim_pcie_bus_width.sv"
...
set_global_assignment -name SYSTEMVERILOG_FILE "${PCIE_SHIMS_DIR}/pcie_multi_link/ofs_fim_pcie_multi_link_afu_dfh.sv"
