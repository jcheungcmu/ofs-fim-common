...
* [pcie\_bus\_width](pcie_bus_width) modules map between narrow and wide TLP AXI streams. The modules are typically used for supporting 128 or 256 bit buses in modules that expect at least 512 bits.
